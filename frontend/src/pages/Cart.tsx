  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2 font-sans">Shopping Cart</h1>
                      ...
                      <div className="flex justify-between items-end">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="p-1 text-gray-600 hover:text-primary-600 border border-gray-300 rounded-lg"
                          >
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-medium p-6 sticky top-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    />
                ...
                <div className="space-y-3">
                  <button className="btn-primary w-full py-3 inline-flex items-center justify-center">
                    Proceed to Checkout
