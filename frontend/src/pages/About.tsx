      ...
      <section className="relative bg-gradient-to-br from-primary-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 font-sans">
              Our Story
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-3xl font-bold text-gray-900 font-sans">Our History</h2>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-gray-900 font-sans">Our Founding Parents</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-white rounded-3xl p-8 border border-primary-100 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Father's Name</h3>
            ...
            <div className="bg-gradient-to-br from-secondary-50 to-white rounded-3xl p-8 border border-secondary-100 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Mother's Name</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-3xl font-bold text-gray-900 font-sans">Current Leadership</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Brother 1 */}
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Brother 1 Name</h3>
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Brother 2 Name</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              <Users className="w-8 h-8 text-primary-600 mr-3" />
              <h2 className="text-3xl font-bold text-gray-900 font-sans">Our Team</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Team Member 1 */}
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">John Smith</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">Sarah Johnson</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">Michael Chen</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full mb-4 flex items-center justify-center">
                  <Heart className="w-12 h-12 text-gray-600" />
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">Emily Davis</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">David Wilson</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">Lisa Anderson</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">James Taylor</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-medium hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 font-sans">Rachel Brown</h3>
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded-full text-xs">Team Building</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-white rounded-3xl p-8 border border-primary-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 font-sans">Our Vision</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-secondary-50 to-white rounded-3xl p-8 border border-secondary-100">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 font-sans">Our Mission</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
